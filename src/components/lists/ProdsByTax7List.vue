  ...
  <div class="">
      ...
      <div class="ProdList ">
        <div class="scrollmenu d-sm-none d-none">
            <ProdCard v-for="Product in ProdByTax7" v-bind:key="Product.id" v-bind:Product="Product"></ProdCard>
        </div>
        <div class="container">
          <div class="row">
              <ProdGridBox v-for="Product in ProdByTax7" v-bind:key="Product.id" v-bind:Product="Product" class="col-4 col-sm-3 GridItem"></ProdGridBox>                
          </div>
        </div>
      </div>
  </div>
